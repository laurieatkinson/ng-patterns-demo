...
import { IDataTableColumn, IDataTableRowExpansionField } from './data-table-models';
...
export class DataTableComponent implements OnInit {
    ...
    @Input() columns: Array<IDataTableColumn>;
    @Input() details: Array<IDataTableRowExpansionField>;
    ...
    displayColumns: Array<IDataTableColumn> = [];
    ...
    getOptionsColumnLabel(item: any, column: IDataTableColumn) {
        if (column.options) {
    ...
    showFooter(column: IDataTableColumn, columnIndex: number) {
