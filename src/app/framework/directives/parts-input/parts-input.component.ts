...
@Component({
  selector: 'la-input',
  templateUrl: './parts-input.component.html',
  styleUrls: ['./parts-input.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class PartsInputComponent implements OnInit {
  ...
  constructor(private elementRef: ElementRef) { }
    ...
    selectDate(event: any) {
        //this.updateWithCorrectTimeZone(event);
    ...
    private updateWithCorrectTimeZone(value: Date) {
        const now = new Date();
        const minuteOffset = now.getTimezoneOffset();
        value.setMinutes(value.getMinutes() + minuteOffset);
    }
