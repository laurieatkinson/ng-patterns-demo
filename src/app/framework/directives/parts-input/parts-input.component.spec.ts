...
import { PartsInputComponent } from './parts-input.component';

describe('PartsInputComponent', () => {
    let component: PartsInputComponent;
    beforeAll(() => {
        TestInjector.setInjector();
    });

    beforeEach(() => {
        component = new PartsInputComponent(new MockElementRef());
    });
